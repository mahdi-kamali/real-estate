...
function NewEstatesCard(props) {
    return <div className="card" >
        <div className="card-image">
            <img src={props.estate.download_url} alt="" />
        </div>
            ...
            <Accordion>
                <Accordion.Item eventKey="0">
                    ...
                    <AccordionBody>
                        ...
                        <button className='accordion-buttons'>
                            <Icon icon="carbon:data-view-alt" color="black" />
                            Arrange Viewing
                        </button>
                    </AccordionBody>
                </Accordion.Item>
